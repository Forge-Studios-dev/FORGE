...
FORGE is a **skill-first creator platform** powered by **YouTube-style mechanics** on this stack: **NestJS API** (`apps/api`), **Next.js web/admin** (`apps/web`, `apps/admin`), **Flutter mobile** (`apps/mobile`), with BullMQ, Socket.IO, and a video/feed/analytics stack.
