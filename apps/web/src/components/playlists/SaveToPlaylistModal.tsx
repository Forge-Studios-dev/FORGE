  ...
  return (
    ...
    >
      <div
        ...
        className="glass-panel w-full max-w-md rounded-2xl p-5 shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mb-4 flex items-center justify-between gap-3">
          <h2 className="font-display-forge text-lg font-semibold">Save to…</h2>
          <button
            type="button"
            onClick={onClose}
                ...
                <li key={pl.id}>
                  <label className="flex cursor-pointer items-center gap-3 rounded-xl px-2 py-2.5 hover:bg-surface-container-high">
                    <input
                      ...
                      onChange={() =>
                        toggle.mutate({ playlistId: pl.id, next: !checked })
                      }
                    />
